...
and it happens to have a recursive definition. The first two values in the sequence are 0 and 1
...
public class Fibonacci {
    ...
    public static int fibonacci(int n) {
        if(n<=1)
            return n;
        return fibonacci(n-1)+fibonacci(n-2); //time Complexity O(2^n)
    }
}
